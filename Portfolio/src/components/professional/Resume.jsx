                    ...
                    <div className="space-y-24 max-w-4xl">
                        ...
                        <div className="space-y-20 pl-16 border-l-2 border-white/5 relative">
                            ...
                            >
                                ...
                                <div className="text-[10px] font-black uppercase tracking-[0.6em] text-white/50 mb-10 italic">Core Mission: AI Interface Architect // Software Intern</div>
                                <p className="text-lg text-white/40 leading-relaxed font-light group-hover:text-white/60 transition-colors uppercase tracking-[0.15em] max-w-3xl">Architecting high-performance AI teaching avatars. Synchronizing textbook data with adaptive Learning Models using the full MERN ecosystem. Optimizing interactive user flow for next-gen educational platforms.</p>
                            </motion.div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-20 md:pr-16 md:border-r-2 border-white/5 relative">
                            ...
                            >
                                ...
                                <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-6 w-full md:justify-end">
                                    <span className="text-[12px] font-black text-white/40 uppercase tracking-[0.4em] font-mono py-2 px-6 bg-white/5 rounded-full border border-white/5 order-2 md:order-1 whitespace-nowrap">2023 – 2026</span>
                                ...
                                <div className="text-[10px] font-black uppercase tracking-[0.6em] text-white/50 mb-10 italic">Archive Record: B.Tech Computer Science — 9.22 CGPA Excellence</div>
                                <p className="text-lg text-white/40 leading-relaxed font-light group-hover:text-white/60 transition-colors uppercase tracking-[0.15em] max-w-3xl md:ml-auto">Engineering innovative software solutions with a focus on cross-technology integration. Mastering the core principles of high-performance system architecture and user-centric professional design.</p>
                            </motion.div>
                        </div>
                    </div>
                </div>
